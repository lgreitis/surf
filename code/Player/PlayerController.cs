...
namespace Surf
{
    ...
    class PlayerController : BasePlayerController
    {
		...
		public float WalkSpeed { get; set; } = 310.0f;
		public float DefaultSpeed { get; set; } = 310.0f;
		...
		public virtual void WalkMove()
		{
			...
			Velocity = Velocity.WithZ(0);
			//AccelerateNew(wishdir, wishspeed, 5f, 4f);
		...
		public virtual void AccelerateNew(Vector3 wishdir, float wishspeed, float accel, float surfaceFriction)
		{
			...
			var accelspeed = accel * Time.Delta * wishspeed * surfaceFriction;
		...
		public virtual void AirMove()
		{
			...
			AirAccelerateNew(wishdir, wishspeed, 1500, 30f);
		...
		public virtual void AirAccelerateNew(Vector3 wishdir, float wishspeed, float accel, float airCap)
		{
			//gainCoefficient = 0f;
			...
			var accelspeed = accel * wishspeed * Time.Delta;
			...
			{
				//gainCoefficient = (wishSpd - Math.Abs(currentspeed)) / wishSpd;
			}
